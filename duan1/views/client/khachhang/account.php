...
<style>
    .avatar-img {
        max-width: 200px;
        /* Điều chỉnh kích thước tối đa theo ý muốn */
        max-height: 200px;
    }
</style>
<main class="h-full">
    <div class="page-container relative h-full flex flex-auto flex-col px-4 sm:px-6 md:px-8 py-4 sm:py-6">
        ...
        <div class="tabs">
            <div role="tablist" class="tab-list tab-list-underline">
                <button class="btn btn-primary" data-bs-toggle="tab" data-bs-target="#tab-profile" role="tab"
                    aria-selected="true" tabindex="0">
                    Thông tin cơ bản
                </button>
                <button class="btn btn-primary" data-bs-toggle="tab" data-bs-target="#tab-password" role="tab"
                    aria-selected="false" tabindex="1">
                    Mật Khẩu
                </button>
                <button class="btn btn-primary" data-bs-toggle="tab" data-bs-target="#tab-order" role="tab"
            ...
            <div class="card adaptable-card">
                <div class="card-body">
                            ...
                            <form action="index.php?act=account" method="POST" enctype="multipart/form-data">
                                <div class="form-container vertical">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label font-weight-bold">Họ Và
                                            Tên</label>
                                        <div class="col-md-9">
                                            <div class="input-group">

                                                <input type="text" class="form-control pl-8" id="name" name="name"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control pl-8" id="email" name="email"
                                                    autocomplete="off" placeholder="Email" value="<?php echo $email ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control pl-8" id="email" name="makh"
                                                    autocomplete="off" placeholder="Email"
                                                    value="<?php echo $ma_khach_hang ?>" hidden>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="upload upload-draggable hover:border-primary-600 min-h-fit">
                                                <input class="form-control-file upload-input draggable" type="file"
                                                    title="" value="" name="anh" onchange="previewImagesindex(event)">
                                            ...
                                            <span
                                                ...
                                                data-avatar-size="60">
                                                <img class="avatar-img avatar-circle" src="<?php echo $hinhpath ?>" loading="lazy">
                                            </span>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control pl-8" name="sdt"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pl-8" name="diachi"
                                                autocomplete="off" placeholder="Địa chỉ" value="<?php echo $dia_chi ?>">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade show active" id="tab-password" role="tabpanel"
                            ...
                            <form action="index.php?act=account" method="POST">
                                <div class="form-container vertical">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label font-weight-bold">Mật khẩu
                                            cũ</label>
                                        <div class="col-md-9">
                                            <div class="input-group">

                                                <input type="password" class="form-control pl-8" name="oldpass"
                                                    autocomplete="off" placeholder="Mật khẩu cũ">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control pl-8" name="newpass"
                                                    autocomplete="off" placeholder="Mật khẩu mới">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="name" class="col-md-3 col-form-label font-weight-bold">Nhập lại mật
                                            khẩu mới</label>
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="password" class="form-control pl-8" name="repass"
                                                    autocomplete="off" placeholder="Mật khẩu mới">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <hr>
                    <div class="tab-content px-4 py-6">
                        <div class="tab-pane fade show active" id="tab-order" role="tabpanel" aria-labelledby="home-tab"
                            tabindex="2">
                        </div>
                ...
                <td class="text-center">
                  <div class="d-flex flex-nowrap justify-content-center">
                    <a href="index.php?act=ctdh&ma_don_hang=<?=$ma_don_hang?>" class="btn btn-primary py-4 fs-13px btn-xs me-4">Detail</a>
                    <div class="dropdown no-caret">
                      ...
                      <div class="dropdown-menu dropdown-menu-end m-0">
                        <a class="dropdown-item" href="index.php?act=ctdh&ma_don_hang=<?=$ma_don_hang?>">View detail</a>
                        <?php if($trang_thai_don==1){?>
                        <a class="dropdown-item" href="index.php?act=danhan&ma_don_hang=<?=$ma_don_hang?>" onclick="return confirm('Bạn có muốn xác nhận đã nhận đơn hàng này')">Đã nhận hàng</a>
                         <?php }else{}?>
                        <?php if($trang_thai_don ==0){?>
                        <a class="dropdown-item text-danger" href="index.php?act=huydh&ma_don_hang=<?=$ma_don_hang?>" onclick="return confirm('Bạn có chắc chắn muốn hủy đơn hàng này')">Delete</a>
                      <?php  }else{}
                        ?>
                      </div>
                    </div>
                                            ...
                                            //     ?>
                                                <tr>
                                                    ...
                                                    <!-- <td>
                                                        <div class="flex items-center">
                                                            <span><?php 
                                                            // echo number_format($tong_gia_don_hang, 0, ',', '.') . 'đ' 
                                                            ?></span>
                                                        </div>
                                                    </td> -->
                                                    ...
                                                    // if ($trang_thai_don == 0) {
                                                        ...
                                                        <!-- <td>
                                                            <span
                                                                class="badge rounded-lg rounded-pill alert py-3 px-4 mb-0 alert-warning border-0 text-capitalize fs-12">Cần
                                                                Xác thực</span>
                                                        </td> -->
                                                        <?php
                                                    // } elseif ($trang_thai_don == 1) {
                                                        ...
                                                        <!-- <td>
                                                            <span
                                                                class="badge rounded-lg rounded-pill alert py-3 px-4 mb-0 alert-success border-0 text-capitalize fs-12">Đã
                                                                Thanh Toán</span>
                                                        </td> -->
                                                        <?php
                                                    // } elseif ($trang_thai_don == 2) {
                                                        ...
                                                        <!-- <td>
                                                            <span
                                                                class="badge rounded-lg rounded-pill alert py-3 px-4 mb-0 alert-danger border-0 text-capitalize fs-12">Chưa
                                                                Thanh toán</span>
                                                        </td> -->
                                                        <?php
                                                    // } elseif ($trang_thai_don == 3) {
                                                        ...
                                                        <!-- <td>
                                                            <span
                                                                class="badge rounded-lg rounded-pill alert py-3 px-4 mb-0 alert-danger border-0 text-capitalize fs-12">Đã
                                                                Hủy</span>
                                                        </td> -->
                                                        <?php
                                                    // }
                                                    ...
                                                    <!-- <td class="text-center">
                                                        <div class="d-flex flex-nowrap justify-content-center">
                                                            <a href="index.php?act=chitietdh&ma_don_hang=<?php echo $ma_don_hang ?>"
                                                                class="btn btn-primary py-4 fs-13px btn-xs me-4">Chi tiết
                                                                đơn hàng</a>

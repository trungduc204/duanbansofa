      ...
      <div class="col-lg-5 col-md-8 mx-auto">
        <form action="index.php?act=register" method="post">
          ...
          <div class="mb-6">
            ...
            <input name="sdt" id="" type="number" class="form-control" placeholder="Số điện Thoại" >
          </div>
          <div class="mb-6">
            <label for="email" >Họ Và Tên</label>
            <input name="ten_khach_hang" id="" type="text" class="form-control" placeholder="họ và tên" >
          </div>
          <div class="mb-7 ">
            <label for="dia_chi" >Địa chỉ</label>
            <input name="dia_chi" id="Địa chỉ" type="text" class="form-control" placeholder="Adress" >
          </div>

          <div class="mb-7 ">
            <label for="password" >Mật Khẩu</label>
            <input name="mat_khau" id="password" type="password" class="form-control" placeholder="Password" >
          </div>
    
          <div class="mb-7">
            <label for="password" > Nhập lại mật Khẩu</label>
            <input name="re_mat_khau" id="password" type="password" class="form-control" placeholder="Password" >
          </div>
